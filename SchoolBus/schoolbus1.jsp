...
<script src="js/schoolbus1.js"></script>
	...
	<div data-role="page" data-theme="a" data-dom-cache="true"
		...
		<script type="text/javascript">
			...
			$("#contentPage1").on('pageinit', function() {
			    getgps();
				$(function() {
					window.setInterval(getgps, 1000 * 10);
				}); 
...
to {
	-webkit-transform: rotate(360deg) translateZ(0);
		...
		<div data-role="content">
			<div class="details-content">
				<div class="user-head">
					<img src="img/logo.png" alt="John" class="image-wrap">
    ...
    <a href="#" onclick=""><div id="timeDiv" class="time"></div></a>
				...
				<div class="user-heart">
					<div class="dividing-line"><a href="#" onclick="api.showMapodb2()">
					<div id="htime" class="htime2">Tracking......</div></a></div>
